...
export const INVALID_ID_FORMAT = (id, reason) =>
    `Invalid ID Format: ${JSON.parse(id)} | ${reason}`;
...
export const WARNING_USER_DUPLICATE =
    'This User is already saved in the database.';
